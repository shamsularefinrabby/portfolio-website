  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
      ...
      <div class="card pd-20 pd-sm-40">
        ...
        <form action="overview-edit-post.php" method="post">
          <div class="form-layout">
            <div class="row mg-b-25">
                <div class="col-lg-6 form-control">
                    <div class="form-group">
                        <label class="form-control-label">Overview Title: <span class="tx-danger">*</span></label>
                        <input class="form-control" type="text" name="title" value="<?= panda_single("overview",$_GET['link'])['title']?>">
